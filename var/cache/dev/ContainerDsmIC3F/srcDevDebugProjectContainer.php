...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'App\\Controller\\SubjectController' => 'getSubjectControllerService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('t4g-poQFph', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('l60X9tXmlp', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy(($this->targetDirs[3].'/src/../public/build/manifest.json')), new \Symfony\Component\Asset\Context\RequestStackContext($b, '', false)), array())));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kXDLo-0kbO', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LQDwAxCAHF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('17z9kOu-Tf', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['App\Security\Voter\SubjectVoter'] ?? $this->privates['App\Security\Voter\SubjectVoter'] = new \App\Security\Voter\SubjectVoter());
    ...
    protected function getForm_RegistryService()
    {
        ...
        }, 'App\\Form\\SubjectType' => function () {
            return ($this->privates['App\Form\SubjectType'] ?? $this->privates['App\Form\SubjectType'] = new \App\Form\SubjectType());
    ...
    protected function getTwig_Loader_NativeFilesystemService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/symfony/debug-bundle/Resources/views'), '!Debug');
        $instance->addPath(($this->targetDirs[3].'/vendor/harmony-project/ui-bundle/Resources/views'), 'HarmonyUi');
        $instance->addPath(($this->targetDirs[3].'/vendor/harmony-project/ui-bundle/Resources/views'), '!HarmonyUi');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'HarmonyUiBundle' => array(
                    'path' => ($this->targetDirs[3].'/vendor/harmony-project/ui-bundle'),
                    'namespace' => 'Harmony\\Bundle\\UiBundle',
                ),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HarmonyUiBundle' => 'Harmony\\Bundle\\UiBundle\\HarmonyUiBundle',
            ...
            'twig.form.resources' => array(
                ...
                1 => '@HarmonyUi/form/semantic_2_layout.html.twig',
            ),
