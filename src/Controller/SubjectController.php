...
class SubjectController extends Controller
{
    ...
    public function enroll(Request $request, Subject $subject){
        ...
        $this->denyAccessUnlessGranted($subject, 'ENROLL');
        ...
        $this->addFlash('positive', "Te has inscrito correctamente en la asignatura");

        return $this->redirectToRoute('subject_index');
    }

    /**
     *  @Route("/{id}/unenroll", name="subject_delete")
     */
    public function unenroll(Request $request, Subject $subject){
        $this->denyAccessUnlessGranted($subject, 'UNENROLL');
        ...
        $this->addFlash('positive', "Te has quitado correctamente en la asignatura");
